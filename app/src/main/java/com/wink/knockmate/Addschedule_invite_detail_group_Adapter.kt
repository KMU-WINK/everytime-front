...
class Addschedule_invite_detail_group_Adapter(private val context: Context) :
    RecyclerView.Adapter<Addschedule_invite_detail_group_Adapter.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val groupImage = itemView.findViewById<ImageView>(R.id.detail_profile_image)
        private val groupName = itemView.findViewById<TextView>(R.id.detail_profile_name)
        var boolean = false
